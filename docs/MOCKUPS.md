...
```
┌─────────────────────────────────────────────────────────────┐
│  ÉTAT CLIENTS                              [Export PDF]     │
├─────────────────────────────────────────────────────────────┤
│  [2026 ▼]  [Avril ▼]         Afficher : [Tous ▼]           │
│             [Tous les mois]               [Tous]            │
│             [Janvier]                     [Avec dettes 🔴]  │
│             [...]                         [Soldés 🟢]       │
├─────────────────────────────────────────────────────────────┤
...
├──────────────────┼───────────────┼────────────┼────────────┤
│ Mohamed A.       │ 1 200,00 MAD  │  600,00 MAD│  600,00 MAD│🔴│
│ Sara B.          │ 5 000,00 MAD  │5 000,00 MAD│    0,00 MAD│🟢│
│ Karim C.         │ 8 000,00 MAD  │2 000,00 MAD│6 000,00 MAD│🔴│
├──────────────────┴───────────────┴────────────┴────────────┤
│ TOTAL   14 200,00 MAD   7 600,00 MAD   6 600,00 MAD        │
└─────────────────────────────────────────────────────────────┘
```

Règles :
- Dropdown Année : années issues de la table `sales` (+ année courante si absente), tri décroissant
- Dropdown Mois : "Tous les mois" (month=0 → plage 01-01 au 31-12) + Janvier…Décembre
- Filtre Afficher : client-side sur les lignes chargées, recalcule les totaux
- Reste : 🔴 rouge si > 0, 🟢 vert si = 0
- Ligne TOTAL en gras sous le tableau (card séparée), couleurs identiques aux colonnes
...
├──────────────────┼───────────────┼────────────┼────────────┤
│ Fournisseur A    │15 000,00 MAD  │12 000,00 MAD│3 000,00 MAD│🔴│
│ Fournisseur B    │ 8 000,00 MAD  │ 8 000,00 MAD│   0,00 MAD│🟢│
├──────────────────┴───────────────┴────────────┴────────────┤
│ TOTAL   23 000,00 MAD   20 000,00 MAD   3 000,00 MAD       │
└─────────────────────────────────────────────────────────────┘
```

Mêmes règles que section 16 (source : table `purchases`).
└──────────────────┴───────────────┴────────────┴────────────┘
