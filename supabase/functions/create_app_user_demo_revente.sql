...
-- Usage : SELECT * FROM public.create_app_user_demo_revente('demo@prospect.ma');
--         SELECT * FROM public.create_app_user_demo_revente('demo@prospect.ma', 'MonPass123', 'Mon Distributeur SARL');
