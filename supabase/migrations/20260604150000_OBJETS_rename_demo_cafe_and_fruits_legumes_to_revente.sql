-- Renommage : ajout du préfixe revente_ pour clarifier le domaine d'activité
--   create_app_user_demo_cafe          → create_app_user_demo_revente_cafe
--   create_app_user_demo_fruits_legumes → create_app_user_demo_revente_fruits_legumes

DROP FUNCTION IF EXISTS public.create_app_user_demo_cafe(text, text, text);
DROP FUNCTION IF EXISTS public.create_app_user_demo_cafe(text, text, text, numeric, text, boolean);
DROP FUNCTION IF EXISTS public.create_app_user_demo_fruits_legumes(text, text, text);
DROP FUNCTION IF EXISTS public.create_app_user_demo_fruits_legumes(text, text, text, numeric, text, boolean);

-- ══════════════════════════════════════════════════════════════════════════════
-- create_app_user_demo_revente_cafe
-- ══════════════════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    -- 9b. Initialiser document_sequences
    ...
    -- 10. Ajustements manuels de stock
    -- Café Décaféiné (index 5, seuil=50) → rupture
    v_target := 0;
    ...
    END IF;
    -- Sirop Café Vanille (index 13, seuil=15) → stock faible
    v_target := 5;
...
-- ══════════════════════════════════════════════════════════════════════════════
-- create_app_user_demo_revente_fruits_legumes
-- ══════════════════════════════════════════════════════════════════════════════
