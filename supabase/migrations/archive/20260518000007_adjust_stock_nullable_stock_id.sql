-- Fix: adjust_stock accepte p_stock_id = NULL pour les produits sans ligne stock
-- (ex: produit fini déclaré en production pour la première fois)
-- Dans ce cas la fonction crée la ligne stock à 0 avant d'appliquer le delta.
