-- Correction des fonctions SECURITY DEFINER : validation de l'appelant

-- 1. get_next_doc_sequence : vérifier que p_user_id = auth.uid()
...
-- 2. create_invoice : vérifier que la vente et le client appartiennent à l'utilisateur
...
-- 3. create_receipt : vérifier que le paiement et la vente appartiennent à l'utilisateur
