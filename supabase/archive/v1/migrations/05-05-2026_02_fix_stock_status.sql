-- Fix : stock négatif (< 0) doit être 'rupture', pas 'faible'
-- Changement minimal : CASE WHEN quantity = 0 → CASE WHEN quantity <= 0
-- Fonction complète copiée de 20260501_01_dashboard_optimization.sql
