...
export const InvoicePreviewPage = () => {
  ...
  return (
    <div className="flex flex-col h-full -m-4 lg:-m-6">
      {/* Top bar — 2 lignes sur mobile, 1 ligne sur desktop */}
      <div className="shrink-0 border-b bg-background">
        ...
        {!isLoading && (
          <div className="flex items-center gap-2 px-4 pb-3 flex-wrap">
            {/* Select mode paiement — s'étire pour remplir l'espace restant */}
            <select
              className="h-8 rounded-md border border-input bg-background px-2 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring flex-1 min-w-[130px] max-w-[200px]"
              value={modePaiement}
